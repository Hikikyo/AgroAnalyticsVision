...
stateController.$inject = ['$scope', '$timeout', '$window'];

function stateController($scope, $timeout, $window) {

    $scope.states = [{"id": "59867b535718ddc0b8efd98a", "name": "Amazonas", "name_abbr": "AM"},
